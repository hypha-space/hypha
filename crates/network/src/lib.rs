...
pub fn private_cidrs() -> Vec<IpNet> {
    vec![
        IpNet::from_str("10.0.0.0/8").expect("alid CIDR"),
        IpNet::from_str("172.16.0.0/12").expect("alid CIDR"),
        IpNet::from_str("192.168.0.0/16").expect("alid CIDR"),
    ]
}
...
pub fn link_local_cidrs() -> Vec<IpNet> {
    vec![
        IpNet::from_str("169.254.0.0/16").expect("alid CIDR"),
        IpNet::from_str("fe80::/10").expect("alid CIDR"),
    ]
}

/// IPv6 unique local address CIDRs.
pub fn unique_local_ipv6_cidrs() -> Vec<IpNet> {
    vec![IpNet::from_str("fc00::/7").expect("alid CIDR")]
}
