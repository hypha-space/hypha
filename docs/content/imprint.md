...
Contact phone: +49 40-22 86 03 19 2
Email: hello@katulu.io

Information provided according to Sec. 5 German Telemedia Act (TMG)

Represented by Managing Directors: Michael Kühne-Schlinkert & Anne Mareike Schlinkert

Register entry Entry in the Handelsregister. 
Registering court: Amtsgericht Hamburg 
Registration number: HRB 151721
...
Unless otherwise noted, Hypha documentation content is available under the [Apache License 2.0](https://github.com/hypha-space/hypha/blob/main/LICENSE-APACHE). The Hypha Space name and visual identity (including the Hypha Space and Katulu logos) remain protected trademarks and are not covered by the Apache 2.0 grant.
