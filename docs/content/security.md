...
For complete details on the mTLS implementation, design rationale, security considerations, and comparison with standard libp2p, see the [mTLS RFC](https://github.com/hypha-space/hypha/blob/alpha/rfc/2025-05-30_mtls.md).
